...
public class SessionServlet extends HttpServlet{
	...
	//return a JSON representation of the currentlt authenticated user for a request's JSESSIONID
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException{
		...
		try {
			...
			//user ObjectMapper (part of the Jackson api) to convert Java Object to JSON representation
