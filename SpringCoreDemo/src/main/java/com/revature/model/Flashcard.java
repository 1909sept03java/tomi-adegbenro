...
public class Flashcard implements InitializingBean, DisposableBean{
	...
	public void afterPropertiesSet() throws Exception {
		System.out.println("implemented afterPropertiesSet"); //implemented with InitializingBean class
		
	}
	
	public void customInit() {
		System.out.println("custom init method"); //implemented with InitializingBean class
	}
	@Override
	public void destroy() throws Exception {
		System.out.println("implemented destroy");
		
	}
	
	public void customDestroy() {
		System.out.println("implemented custom destroy");
	}
