...
INSERT ALL
INTO EMPLOYEE (F_NAME, L_NAME, MGR, M_ROLE)
VALUES('Julius', 'Caesar', 2, 0)
INTO EMPLOYEE (F_NAME, L_NAME, MGR, M_ROLE)
VALUES('Augustus', 'Caesar', 2, 1)
SELECT * FROM DUAL;
/

--INSERTING DUMMY DATA INTO CREDENTIALS
INSERT ALL
INTO CREDENTIALS (UNAME, PASS, EMP_NUM)
VALUES('jcaesar', 'p4ss', 1)
INTO CREDENTIALS (UNAME, PASS, EMP_NUM)
VALUES('acaesar', 'word', 2)
SELECT * FROM DUAL;
/
