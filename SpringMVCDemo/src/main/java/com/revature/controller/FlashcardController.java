...
public class FlashcardController {
	...
	//private List<Flashcard> cardList = new ArrayList<Flashcard>(); // No longer needed if FlashcardService is created
	...
	public ResponseEntity<List<Flashcard>> getAll() {
		//this.cardList.add(new Flashcard("what is the answer to life, the universe, and everything?","42", new Topic("coding"))); // No longer needed if FlashcardService is created
	...
	// DELETE )
		...
		public ResponseEntity<String> deleteFlashcard(@RequestParam int id) {
			ResponseEntity<String> resp = null;
				try {
